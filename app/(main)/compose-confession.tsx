/**
 * COMPOSE CONFESSION - BLOCKED
 *
 * This feature is temporarily blocked due to missing backend args:
 * - api.confessions.createConfession: missing userId
 *
...
export default function ComposeConfessionScreen() {
  ...
  if (__DEV__) {
    console.log('[BLOCKED FEATURE]', 'compose_confession');
  }
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.description}>
          Share your anonymous confessions. This feature is being enhanced.
        </Text>
