/**
 * COMMENT CONNECT REQUESTS - BLOCKED
 *
 * This feature is temporarily blocked due to missing backend functions:
 * - api.confessions.getPendingCommentConnects (doesn't exist)
 * - api.confessions.respondToCommentConnect (doesn't exist)
 * - Missing export: asCommentConnectId
 *
...
export default function CommentConnectRequestsScreen() {
  ...
  if (__DEV__) {
    console.log('[BLOCKED FEATURE]', 'comment_connect_requests');
  }
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.description}>
          Manage connection requests from confessions. This feature is being built.
        </Text>
