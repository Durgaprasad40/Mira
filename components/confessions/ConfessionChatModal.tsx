...
import { ConfessionChat, ConfessionChatMessage, MutualRevealStatus } from '@/types';

interface ConfessionChatModalProps {
  visible: boolean;
  chat: ConfessionChat | null;
  currentUserId: string;
  confessionText?: string;
  onClose: () => void;
  onSendMessage: (text: string) => void;
  onAgreeReveal: () => void;
  onDeclineReveal: () => void;
  onBlock: () => void;
}
...
export default function ConfessionChatModal({
  visible,
  chat,
  currentUserId,
  confessionText,
  ...
  // Determine if current user has already agreed
  ...
  // Show reveal prompt if someone requested and I haven't responded, or nobody requested yet
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Reveal Action Buttons — shown when other side requested or user can initiate */}
        {showRevealActions && (
            ...
            {otherRequested ? (
              <>
                ...
                <View style={styles.revealButtonRow}>
                  <TouchableOpacity style={styles.revealAgreeButton} onPress={onAgreeReveal}>
                    <Ionicons name="checkmark" size={16} color={COLORS.white} />
                    <Text style={styles.revealAgreeText}>Agree to Reveal</Text>
                  </TouchableOpacity>
                  <TouchableOpacity style={styles.revealDeclineButton} onPress={onDeclineReveal}>
              ...
              <TouchableOpacity style={styles.revealRequestButton} onPress={onAgreeReveal}>
